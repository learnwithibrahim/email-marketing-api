...
const integrationsData = [
  {
    ...
    category: "CRM",
    description:
      "Sync contacts, leads, and accounts directly to your Salesforce instance in real-time.",
    icon: (
      <svg
        width="28"
        height="28"
  ...
  },
  {
    ...
    category: "CRM",
    description:
      "Automatically update your HubSpot CRM with enriched firmographic and contact data.",
    icon: (
      <svg
        width="28"
        height="28"
  ...
  },
  {
    ...
    description:
      "Get instant notifications for new leads, campaign replies, and export completions.",
    icon: (
      <svg
        width="28"
        height="28"
  ...
  },
  {
    ...
    description:
      "Push verified prospects straight into your active Outreach sequences with one click.",
    icon: (
      <svg
        width="28"
        height="28"
  ...
  },
  {
    ...
    category: "Automation",
    description:
      "Connect with over 5,000+ apps to automate your entire lead generation workflow.",
    icon: (
      <svg
        width="28"
        height="28"
  ...
  },
  {
    ...
    category: "ATS",
    description:
      "Seamlessly import candidate profiles and contact info directly into your ATS pipeline.",
    icon: (
      <svg
        width="28"
        height="28"
  ...
  },
  {
    ...
    category: "Sales Engagement",
    description:
      "Enroll enriched contacts into SalesLoft cadences automatically to scale outreach.",
    icon: (
      <svg
        width="28"
        height="28"
  ...
  },
  {
    ...
    category: "Marketing",
    description:
      "Sync targeted lists directly to Mailchimp for your next large-scale newsletter blast.",
    icon: (
      <svg
        width="28"
        height="28"
    ...
    <div className="min-h-screen flex flex-col bg-[#FAFAFA]">
      ...
      <main className="flex-grow flex flex-col items-center pt-16 pb-24 px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
            <div className="max-w-2xl">
              ...
              <p className="text-lg text-gray-600">
                Seamlessly push data into the tools your team already uses. No
                manual data entry, no CSV wrangling—just pure productivity.
              </p>
            </div>
        ...
        <div className="max-w-[1200px] w-full flex flex-wrap gap-2 mb-12 border-b border-gray-200 pb-4">
          <button className="px-5 py-2 bg-[#140D36] text-white text-sm font-semibold uppercase tracking-wider">
            All
          </button>
          <button className="px-5 py-2 bg-transparent text-gray-500 hover:text-[#140D36] hover:bg-gray-100 text-sm font-semibold uppercase tracking-wider transition-colors">
            CRM
          </button>
          <button className="px-5 py-2 bg-transparent text-gray-500 hover:text-[#140D36] hover:bg-gray-100 text-sm font-semibold uppercase tracking-wider transition-colors">
            Sales Engagement
        ...
        <div className="max-w-[1200px] w-full bg-[#140D36] p-10 md:p-16 flex flex-col md:flex-row items-center justify-between border border-[#140D36]">
          <div className="max-w-xl mb-8 md:mb-0">
            ...
            <p className="text-gray-400 text-sm md:text-base leading-relaxed">
              Our robust REST API allows enterprise teams to build custom
              integrations and embed our 700M+ contact database directly into
